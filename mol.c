...
molecule *molmalloc(unsigned short atom_max, unsigned short bond_max)
{
    ...
    // allocating memory for the atoms and checking for errors
    m->atom_max = atom_max;
    m->atom_no = 0;
    ...
    // allocating memory for the atom pointers and checking for errors
    ...
    // allocating memory for the bonds and checking for errors
    m->bond_max = bond_max;
    m->bond_no = 0;
    m->bonds = (bond *)malloc(bond_max * sizeof(bond));

    // allocating memory for the bond pointers and checking for errors
    if (m->bonds == NULL)
    {
