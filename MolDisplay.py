...
class Atom:
    ...
    def __init__(self, c_atom):
        self.z = c_atom.z  # Store the z value of the wrapped atom
        self.atom = c_atom  # Store the wrapped atom itself in the atom attribute
...
class Bond:
    ...
    def __init__(self, c_bond):
        self.z = c_bond.z  # Store the z value of the wrapped bond
        self.bond = c_bond  # Store the wrapped bond itself in the bond attribute
...
class Molecule(molecule.molecule):
    ...
    def parse(self, f):
        ...
        for i in range(bond_m): # parse through bonds
            ...
            self.append_bond(int(bond_line_array[0]), int(bond_line_array[1]), int(bond_line_array[2]))
