...
def molappend_atom(molecule, at):
    return _molecule.molappend_atom(molecule, at)

def molappend_bond(molecule, bo):
    return _molecule.molappend_bond(molecule, bo)

def molsort(molecule):
    return _molecule.molsort(molecule)

def compare_atom_z(a, b):
    return _molecule.compare_atom_z(a, b)

def compare_bond_z(a, b):
    return _molecule.compare_bond_z(a, b)
